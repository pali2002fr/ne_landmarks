...
class LandscapesControllerTest < ActionController::TestCase
  ...
  test "should create landscape" do
    assert_difference('Landscape.count') do
      post :create, landscape: { details: @landscape.details, latitude: @landscape.latitude, longitude: @landscape.longitude, name: @landscape.name }
    end
  ...
  test "should update landscape" do
    patch :update, id: @landscape, landscape: { details: @landscape.details, latitude: @landscape.latitude, longitude: @landscape.longitude, name: @landscape.name }
    assert_redirected_to landscape_path(assigns(:landscape))
  end
